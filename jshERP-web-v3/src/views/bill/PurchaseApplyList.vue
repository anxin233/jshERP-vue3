  ...
  <div class="bill-list-page">
    <el-card shadow="never">
        ...
        >
          <template #content>
            <div style="max-width: 300px">
              请购单只涉及数量，请购单可以转采购订单，但需要先对请购单进行审核。<br />
      ...
      >
        <!-- 操作列 -->
        <template #action="{ row }">
          <el-button link type="primary" size="small" @click="myHandleDetail(row, '请购单', prefixNo)">查看</el-button>
      ...
      <!-- ==================== 弹窗区域 ==================== -->
      <PurchaseApplyModal ref="modalFormRef" @ok="modalFormOk" @close="modalFormClose" />
...
defineOptions({ name: 'PurchaseApplyList' })
