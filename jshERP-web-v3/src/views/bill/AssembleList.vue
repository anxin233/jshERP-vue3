  ...
  <div class="bill-list-page">
    <el-card shadow="never">
      ...
      >
        <!-- 操作列 -->
        <template #action="{ row }">
          <el-button link type="primary" size="small" @click="myHandleDetail(row, '组装单', prefixNo)">查看</el-button>
      ...
      <!-- ==================== 弹窗区域 ==================== -->
      <AssembleModal ref="modalFormRef" @ok="modalFormOk" @close="modalFormClose" />
...
import AssembleModal from './components/AssembleModal.vue'
...
defineOptions({ name: 'AssembleList' })
