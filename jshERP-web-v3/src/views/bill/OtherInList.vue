  ...
  <div class="bill-list-page">
    <el-card shadow="never">
      ...
      >
        <!-- 操作列 -->
        <template #action="{ row }">
          <el-button link type="primary" size="small" @click="myHandleDetail(row, '其它入库', prefixNo)">查看</el-button>
      ...
      <!-- ==================== 弹窗区域 ==================== -->
      <OtherInModal ref="modalFormRef" @ok="modalFormOk" @close="modalFormClose" />
...
import OtherInModal from './components/OtherInModal.vue'
...
defineOptions({ name: 'OtherInList' })
...
function modalFormOk() {
  ...
  if (inOutManageFlag.value) {
    initWaitBillCount('入库', '采购,销售退货', '1,3')
  }
}
