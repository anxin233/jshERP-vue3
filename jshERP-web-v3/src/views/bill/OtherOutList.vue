  ...
  <div class="bill-list-page">
    <el-card shadow="never">
      ...
      >
        <!-- 操作列 -->
        <template #action="{ row }">
          <el-button link type="primary" size="small" @click="myHandleDetail(row, '其它出库', prefixNo)">查看</el-button>
      ...
      <!-- ==================== 弹窗区域 ==================== -->
      <OtherOutModal ref="modalFormRef" @ok="modalFormOk" @close="modalFormClose" />
...
import {
  ...
  Setting, QuestionFilled, ArrowUp, ArrowDown, Link,
} from '@element-plus/icons-vue'
import ProTable from '@/components/table/ProTable.vue'
import OtherOutModal from './components/OtherOutModal.vue'
...
defineOptions({ name: 'OtherOutList' })
...
/** 待出库 */
function handleWaitBill() {
  // 待出库功能 - 触发批量待办出库弹窗
  // TODO: 引入 BatchWaitBillList 组件后可在此调用
}

/** 弹窗确认回调 */
function modalFormOk() {
  loadData()
  if (inOutManageFlag.value) {
    initWaitBillCount('出库', '销售,采购退货', '1,3')
  }
}
