  ...
  <div class="bill-list-page">
    <el-card shadow="never">
      ...
      >
        <!-- 操作列 -->
        <template #action="{ row }">
          <el-button link type="primary" size="small" @click="myHandleDetail(row, '采购退货出库', prefixNo)">查看</el-button>
      ...
      <!-- ==================== 弹窗区域 ==================== -->
      <PurchaseBackModal ref="modalFormRef" @ok="modalFormOk" @close="modalFormClose" />
...
defineOptions({ name: 'PurchaseBackList' })
