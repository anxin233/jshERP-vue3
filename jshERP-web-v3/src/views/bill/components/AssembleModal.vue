<template>
  ...
  >
    ...
    <template #footer>
      ...
      <el-button v-if="billPrintFlag && isShowPrintBtn" @click="handlePrintPro('组装单', $refs.modalPrintPro)">
        三联打印-新版
      </el-button>
      <el-button v-if="billPrintFlag && isShowPrintBtn" @click="handlePrint('组装单', $refs.modalPrint)">
        三联打印
      </el-button>
...
defineOptions({ name: 'AssembleModal' })
...
async function handleOk() {
  ...
  try {
    ...
    console.error('[AssembleModal] handleOk error:', e)
