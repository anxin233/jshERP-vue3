  ...
  <div class="bill-list-page">
    <el-card shadow="never">
      ...
      >
        <!-- 操作列 -->
        <template #action="{ row }">
          <el-button link type="primary" size="small" @click="myHandleDetail(row, '调拨出库', prefixNo)">查看</el-button>
      ...
      <!-- ==================== 弹窗区域 ==================== -->
      <AllocationOutModal ref="modalFormRef" @ok="modalFormOk" @close="modalFormClose" />
...
import {
  ...
  Setting, QuestionFilled, ArrowUp, ArrowDown,
} from '@element-plus/icons-vue'
import ProTable from '@/components/table/ProTable.vue'
import AllocationOutModal from './components/AllocationOutModal.vue'
...
defineOptions({ name: 'AllocationOutList' })
