<template>
  <el-card shadow="never">
    ...
    <div class="table-operator">
      ...
      <el-button v-if="btnEnableList.indexOf('3') > -1" :icon="Download" @click="handleExportXls('供应商信息')">导出</el-button>
    </div>
    ...
    <!-- 弹窗组件 -->
    <vendor-modal ref="modalFormRef" @ok="modalFormOk" />
  </el-card>
</template>
...
const {
  ...
  defColumns: [
    ...
    { title: '操作', dataIndex: 'action', key: 'action', align: 'center', width: 130, customRender: 'action' },
...
function handleImportXls() {
  // TODO: 实现导入功能，对接 ImportFileModal 组件
  console.log('导入供应商')
}
</script>
