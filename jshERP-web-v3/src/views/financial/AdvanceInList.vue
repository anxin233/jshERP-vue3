<template>
  <div class="financial-list-page">
    <el-card shadow="never">
      ...
      <!-- ==================== 弹窗区域 ==================== -->
      <AdvanceInModal ref="modalFormRef" @ok="modalFormOk" @close="modalFormClose" />
    </el-card>
  </div>
</template>
...
function handleDetail(row: any) {
  myHandleDetail(row, '收预付款', 'SYF', null, (record: any) => {
