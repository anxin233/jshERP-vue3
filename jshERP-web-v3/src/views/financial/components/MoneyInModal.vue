    ...
    >
          ...
          <el-form-item label="客户" prop="organId">
            ...
            >
              ...
              <template #footer>
                ...
                <div class="dropdown-btn" @click="initCustomer()">
      ...
      <div class="editable-table-section">
        ...
        <div class="editable-table-extra" style="margin-bottom: 8px; display: flex; gap: 8px; flex-wrap: wrap;">
          ...
          <el-button type="primary" :icon="Plus" @click="selectBeginNeed('客户', formModel, accountTable)">选择期初</el-button>
          <el-button :icon="Link" @click="handleWaitNeed('客户', $refs.waitNeedList)">待收款</el-button>
        </div>
      ...
      <el-row :gutter="24">
        ...
        <el-col :lg="6" :md="12" :sm="24">
          <el-form-item label="合计收款">
            <el-input v-model.trim="formModel.totalPrice" placeholder="请输入合计收款" readonly />
          </el-form-item>
        </el-col>
        <el-col :lg="6" :md="12" :sm="24">
        ...
        <el-col :lg="6" :md="12" :sm="24">
          <el-form-item label="实际收款">
            <el-input v-model.trim="formModel.changeAmount" placeholder="请输入实际收款" readonly />
          </el-form-item>
        </el-col>
      </el-row>
...
defineOptions({ name: 'MoneyInModal' })
...
const accountTable = reactive({
  ...
  dataSource: [] as any[],
  columns: [
    { title: '销售单据编号', key: 'billNumber', width: '20%', type: 'input' as const, readonly: true },
    { title: '应收欠款', key: 'needDebt', width: '10%', type: 'inputNumber' as const, statistics: true, readonly: true },
    { title: '已收欠款', key: 'finishDebt', width: '10%', type: 'inputNumber' as const, statistics: true, readonly: true },
    {
      title: '本次收款', key: 'eachAmount', width: '10%', type: 'inputNumber' as const, statistics: true,
...
async function requestSubTableData(urlPath: string, params: any, table: any) {
  ...
  try {
    ...
    console.error('[MoneyInModal] requestSubTableData error:', err)
  } finally {
    table.loading = false
  }
}
...
function handleClickAdd() {
  ...
  if (organId) {
    ...
    // debtBillListRef.value?.show(organId, '出库', '销售', '客户', '')
    ElMessage.info('请选择销售欠款单据')
  } else {
...
async function handleOk() {
  ...
  try {
    ...
    console.error('[MoneyInModal] handleOk error:', e)
