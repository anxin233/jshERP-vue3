<template>
  <div class="financial-list-page">
    <el-card shadow="never">
            ...
            <el-row :gutter="24">
              ...
              <el-col :md="6" :sm="24">
                <el-form-item label="支出账户">
                  <el-select v-model="queryParam.accountId" placeholder="请选择支出账户" filterable clearable style="width: 100%">
                    <el-option
              ...
              <el-col :md="6" :sm="24">
                <el-form-item label="支出项目">
                  <el-select v-model="queryParam.inOutItemId" placeholder="请选择支出项目" filterable clearable style="width: 100%">
                    <el-option
      ...
      <!-- ==================== 弹窗区域 ==================== -->
      <ItemOutModal ref="modalFormRef" @ok="modalFormOk" @close="modalFormClose" />
...
import ItemOutModal from './components/ItemOutModal.vue'
...
defineOptions({ name: 'ItemOutList' })
...
function handleDetail(row: any) {
  myHandleDetail(row, '支出', 'ZC', modalDetailRef.value, (record: any, type: string, prefixNoVal: string) => {
