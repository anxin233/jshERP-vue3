...
<style scoped>
  ...
  .back-layout .lang-setting .select-list :deep(.ant-select-selector) {
    border-color: #f8f8f8 !important;
  }
  .back-layout .lang-setting .select-list :deep(.ant-select:hover .ant-select-selector) {
    border-color: #e8e8e8 !important;
  }
  .back-layout .lang-setting .select-list :deep(.ant-select-focused .ant-select-selector) {
    border-color: #e8e8e8 !important;
