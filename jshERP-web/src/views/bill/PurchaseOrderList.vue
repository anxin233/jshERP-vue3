    ...
    <a-col :md="24">
      <a-card :style="cardStyle" :bordered="false">
              ...
              <a-row :gutter="24">
                ...
                <a-col :md="6" :sm="24">
                  <a-form-item label="关联请购单" :labelCol="labelCol" :wrapperCol="wrapperCol">
                    <a-input placeholder="请输入关联请购单" v-model:value="queryParam.linkApply"></a-input>
                  </a-form-item>
                </a-col>
        ...
        <div class="table-operator"  style="margin-top: 5px">
          ...
          <a-button v-if="quickBtn.purchaseIn.indexOf(1)>-1 && btnEnableList.indexOf(1)>-1" @click="transferBill('转采购入库', quickBtn.purchaseIn)"><template #icon><legacy-icon type="share-alt" /></template>转采购入库</a-button>
          <a-dropdown>
              ...
              <a-checkbox-group @change="onColChange" v-model:value="settingDataIndex" :defaultValue="settingDataIndex">
                <a-row class="column-setting-list" style="width: 500px">
                  <template v-for="(item,index) in columnSettingColumns" :key="item.dataIndex || index">
                    <template>
                      <a-col :span="8" class="column-setting-item" v-if="purchaseBySaleFlag">
                        <a-checkbox :value="item.dataIndex">
                          <j-ellipsis :value="getColumnSettingTitle(item)" :length="10"></j-ellipsis>
                        </a-checkbox>
                      </a-col>
                      <a-col :span="8" class="column-setting-item" v-if="!purchaseBySaleFlag && item.dataIndex!=='linkNumber'">
                        <a-checkbox :value="item.dataIndex">
                          <j-ellipsis :value="getColumnSettingTitle(item)" :length="10"></j-ellipsis>
                        </a-checkbox>
                      </a-col>
    ...
    data () {
      return {
        ...
        defDataIndex:['action','organName','number','materialsList','operTimeStr','userName','materialCount','totalPrice','totalTaxLastMoney',
          'changeAmount','lastDeposit','status'],
        // 默认索引
        defColumns: [
          {
            title: '操作',
