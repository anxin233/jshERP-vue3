    ...
    <a-col :md="24">
      <a-card :style="cardStyle" :bordered="false">
              ...
              <a-row :gutter="24">
                ...
                <a-col :md="6" :sm="24">
                  <a-form-item label="关联订单" :labelCol="labelCol" :wrapperCol="wrapperCol">
                    <a-input placeholder="请输入关联订单" v-model:value="queryParam.linkNumber"></a-input>
                  </a-form-item>
                </a-col>
                <a-col :md="6" :sm="24">
                ...
                <a-col :md="6" :sm="24">
                  <a-form-item label="本次欠款" :labelCol="labelCol" :wrapperCol="wrapperCol">
                    <a-select placeholder="请选择有无本次欠款" allow-clear v-model:value="queryParam.hasDebt">
                ...
                <a-col :md="6" :sm="24">
                  <a-form-item label="最终欠款" :labelCol="labelCol" :wrapperCol="wrapperCol">
                    <a-select placeholder="请选择有无最终欠款" allow-clear v-model:value="queryParam.hasLastDebt">
                      <a-select-option value="1">有欠款</a-select-option>
                      <a-select-option value="0">无欠款</a-select-option>
                    </a-select>
                  </a-form-item>
        ...
        <div class="table-operator"  style="margin-top: 5px">
          ...
          <a-button v-if="quickBtn.purchaseBack.indexOf(1)>-1 && btnEnableList.indexOf(1)>-1" @click="transferBill('转采购退货', quickBtn.purchaseBack)"><template #icon><legacy-icon type="share-alt" /></template>转采购退货</a-button>
        ...
        <div>
          <a-table
            ...
            <template #customRenderDebt="{ text: value, record }">
      ...
      return {
        ...
        defColumns: [
          ...
          { title: '本次欠款', dataIndex: 'debt',width:80,
            customRender: (cell) => this.$renderColumnSlot('customRenderDebt', cell)
          },
