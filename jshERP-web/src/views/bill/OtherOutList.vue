    ...
    <a-col :md="24">
      <a-card :style="cardStyle" :bordered="false">
        ...
        <div class="table-operator"  style="margin-top: 5px">
          ...
          <a-button v-if="inOutManageFlag && btnEnableList.indexOf(1)>-1" @click="handleWaitBill"><template #icon><legacy-icon type="link" /></template>待出库({{waitTotal}})</a-button>
          ...
          <a-tooltip placement="left" title="可以进行库存初始化，生产管理模块的领料出库。">
    ...
    methods: {
      ...
      myHandleDelete(record) {
        ...
        if(record.status === '0') {
          ...
          this.$message.warning("抱歉，只有未审核的单据才能删除，请先反审核！")
        }
      },
      batchDel: function () {
