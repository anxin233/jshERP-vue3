        ...
        <a-row class="form-row" :gutter="24">
          <a-col :lg="6" :md="12" :sm="24">
            <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="会员卡号">
              <a-select placeholder="请选择会员卡号" v-model:value="formModel.organId" :disabled="!rowCanEdit"
          ...
          <div class="sign">
            <a-col :lg="6" :md="12" :sm="24">
              <a-row class="form-row" :gutter="24">
                ...
                <a-col :lg="24" :md="6" :sm="6">
                  <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol">
                    <template #label><span style="font-size: 20px;line-height:20px">付款金额</span></template>
                ...
                <a-col :lg="24" :md="6" :sm="6">
                  <a-form-item name="accountId" :labelCol="labelCol" :wrapperCol="wrapperCol">
                    <template #label><span style="font-size: 20px;line-height:20px">付款账户</span></template>
                    <a-select placeholder="请选择付款账户" style="font-size:20px;" v-model:value="formModel.accountId" :dropdownMatchSelectWidth="false">
                      <template #dropdownRender="{ menuNode: menu }"><div>
                        <v-nodes :vnodes="menu" />
                        <a-divider style="margin: 4px 0;" />
