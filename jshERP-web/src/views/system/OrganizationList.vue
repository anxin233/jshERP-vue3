<template xmlns:background-color="http://www.w3.org/1999/xhtml">
  <a-row :gutter="10">
    ...
    <a-col :md="12" :sm="24">
        ...
        <a-form ref="formRef" :model="formModel" :rules="formRules">
          ...
          <a-form-item name="parentId" :labelCol="labelCol" :wrapperCol="wrapperCol" label="上级部门">
            <a-tree-select style="width:100%" :dropdownStyle="{maxHeight:'200px',overflow:'auto'}"
                           ...
                           :treeData="treeData" v-model:value="formModel.parentId" placeholder="请选择上级部门">
            </a-tree-select>
          </a-form-item>
      ...
      <a-card v-else >
        <a-empty>
          <template #description><span> 请先选择一个部门! </span></template>
        </a-empty>
      </a-card>
    </a-col>
...
export default {
  ...
  methods: {
    ...
    setValuesToForm(record) {
      this.$nextTick(() => {
        this.formModel = pick(record, 'orgAbr', 'orgNo', 'parentId', 'sort', 'remark')
