  ...
  <div ref="container">
    <a-modal
      ...
      <a-spin :spinning="confirmLoading">
        <a-form ref="formRef" :model="formModel" :rules="formRules" id="customerModal">
          ...
          <a-row class="form-row" :gutter="24">
            ...
            <a-col :span="12">
              <a-form-item name="beginNeedGet" :labelCol="labelCol" :wrapperCol="wrapperCol" label="期初应收">
                <a-input placeholder="请输入期初应收" v-model:value="formModel.beginNeedGet" />
              </a-form-item>
            </a-col>
            <a-col :span="12">
              <a-form-item name="allNeedGet" :labelCol="labelCol" :wrapperCol="wrapperCol" label="期末应收">
                <a-input v-model:value="formModel.allNeedGet" :readOnly="true" />
              </a-form-item>
            </a-col>
            <a-col :span="12">
  ...
  export default {
    ...
    methods: {
      ...
      validateSupplierName(rule, value){
        ...
        return checkSupplier({ name: value, type: '客户', id: this.model.id ? this.model.id : 0 }).then((res)=>{
          if(res && res.code===200) {
