    ...
    <a-col :md="24">
      <a-card :style="cardStyle" :bordered="false">
        ...
        <div class="table-operator"  style="margin-top: 5px">
          ...
          <a-button v-if="btnEnableList.indexOf(3)>-1" @click="handleExportXls('会员信息')"><template #icon><legacy-icon type="download" /></template>导出</a-button>
          <a-button v-if="btnEnableList.indexOf(1)>-1" @click="batchSetAdvanceIn()"><template #icon><legacy-icon type="stock" /></template>修正预付款</a-button>
        </div>
        <!-- table区域-begin -->
        <div>
          <a-table
