    ...
    <a-col :md="24">
      <a-card :style="cardStyle" :bordered="false">
              ...
              <a-row :gutter="24">
                ...
                <a-col :md="6" :sm="24">
                  <a-form-item label="采购单号" :labelCol="labelCol" :wrapperCol="wrapperCol">
                    <a-input placeholder="请输入采购单号" v-model:value="queryParam.number"></a-input>
                  </a-form-item>
                </a-col>
                <a-col :md="6" :sm="24">
        ...
        <div class="table-operator"  style="margin-top: 5px">
          ...
          <a-button v-if="btnEnableList.indexOf(1)>-1" @click="myHandleAddWithOrgan"><template #icon><legacy-icon type="link" /></template>待付款({{waitTotal}})</a-button>
