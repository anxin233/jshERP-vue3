      ...
      <a-form ref="formRef" :model="formModel" :rules="formRules">
            ...
            <a-form-item name="organId" :labelCol="labelCol" :wrapperCol="wrapperCol" label="供应商">
              <a-select placeholder="请选择供应商" v-model:value="formModel.organId"
                ...
                <template #dropdownRender="{ menuNode: menu }"><div>
                  ...
                  <div class="dropdown-btn" @mousedown="e => e.preventDefault()" @click="initSupplier"><legacy-icon type="reload" /> 刷新</div>
                </div></template>
        ...
        <j-editable-table
          ...
          <template #buttonBefore>
            <a-row :gutter="24" style="float:left;padding-bottom:8px;">
              ...
              <a-col :md="12" :sm="24" style="padding-left:0">
                <a-button type="primary" @click="selectBeginNeed('供应商')"><template #icon><legacy-icon type="plus" /></template>选择期初</a-button>
              </a-col>
            </a-row>
          </template>
          <template #buttonAfter>
            <a-row :gutter="24" style="float:left;padding-bottom:8px;">
              <a-col :md="12" :sm="24">
                <a-button @click="handleWaitNeed('供应商')"><template #icon><legacy-icon type="link" /></template>待付款</a-button>
              </a-col>
            </a-row>
          </template>
        </j-editable-table>
        ...
        <a-row class="form-row" :gutter="24">
          <a-col :lg="6" :md="12" :sm="24">
            <a-form-item name="accountId" :labelCol="labelCol" :wrapperCol="wrapperCol" label="付款账户">
              <a-select placeholder="请选择付款账户" v-model:value="formModel.accountId"
                :dropdownMatchSelectWidth="false" showSearch optionFilterProp="children">
                <template #dropdownRender="{ menuNode: menu }"><div>
                  <v-nodes :vnodes="menu" />
                  <a-divider style="margin: 4px 0;" />
          ...
          <a-col :lg="6" :md="12" :sm="24">
            <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="合计付款">
              <a-input placeholder="请输入合计付款" v-model:value="formModel.totalPrice" :readOnly="true"/>
            </a-form-item>
          </a-col>
          <a-col :lg="6" :md="12" :sm="24">
          ...
          <a-col :lg="6" :md="12" :sm="24">
            <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="实际付款">
              <a-input placeholder="请输入实际付款" v-model:value="formModel.changeAmount" :readOnly="true"/>
            </a-form-item>
          </a-col>
        </a-row>
        <a-row class="form-row" :gutter="24">
