    ...
    <a-spin :spinning="confirmLoading">
      <a-form ref="formRef" :model="formModel" :rules="formRules">
        ...
        <a-row class="form-row" :gutter="24">
          ...
          <a-col :lg="6" :md="12" :sm="24">
            <a-form-item name="changeAmount" :labelCol="labelCol" :wrapperCol="wrapperCol" label="实付金额">
              <a-input placeholder="请输入实付金额" v-model:value="formModel.changeAmount" :readOnly="true"/>
            </a-form-item>
          </a-col>
          <a-col :lg="6" :md="12" :sm="24">
          </a-col>
    ...
    data () {
      return {
        ...
        confirmLoading: false,
          ...
          changeAmount: [{ required: true, message: '请输入实付金额!', trigger: 'blur' }],
        },
        url: {
