    ...
    <a-col :md="24">
      <a-card :style="cardStyle" :bordered="false">
              ...
              <a-row :gutter="24">
                ...
                <a-col :md="6" :sm="24">
                  <a-form-item label="支出账户" :labelCol="labelCol" :wrapperCol="wrapperCol">
                    <a-select placeholder="请选择支出账户" showSearch allow-clear optionFilterProp="children" v-model:value="queryParam.accountId">
                ...
                <a-col :md="6" :sm="24">
                  <a-form-item label="支出项目" :labelCol="labelCol" :wrapperCol="wrapperCol">
                    <a-select placeholder="请选择支出项目" showSearch allow-clear optionFilterProp="children" v-model:value="queryParam.inOutItemId">
        ...
        <div class="table-operator"  style="margin-top: 5px">
          ...
          <a-tooltip placement="left" title="支出单主要处理一些进货支出以外的支出如水电支出、房租支出等。">
