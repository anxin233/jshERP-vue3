...
<script>
  ...
  import { getFormatDate, getPrevMonthFormatDate, buildInOutMaterialCountQueryParams } from '@/utils/util'
  ...
  export default {
    ...
    methods: {
      moment,
      getQueryParams() {
        return buildInOutMaterialCountQueryParams(this.queryParam, this.ipagination, this.isorter)
      },
