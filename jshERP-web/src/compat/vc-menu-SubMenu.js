// Fork of ant-design-vue/es/vc-menu/SubMenu.js — Vue 3 compat: safe parentMenu when prop not injected
...
import SubPopupMenu from 'ant-design-vue/es/vc-menu/SubPopupMenu';
...
import { noop, loopMenuItemRecursively, getMenuIdFromSubMenuEventKey } from 'ant-design-vue/es/vc-menu/util';
import getTransitionProps from 'ant-design-vue/es/_util/getTransitionProps';

var guid = 0;

function getSubMenuParentMenu(instance) {
  var parentMenu = instance.parentMenu || (instance.$props && instance.$props.parentMenu);
  if (!parentMenu) {
    parentMenu = {
      isRootMenu: false,
      ...
      theme: instance.$props && instance.$props.theme ? instance.$props.theme : 'light'
    };
  }
  return parentMenu;
}
...
var SubMenu = {
  ...
  methods: {
    handleUpdated: function handleUpdated() {
      ...
      var parentMenu = getSubMenuParentMenu(this);
  ...
  render: function render() {
    ...
    var getPopupContainer = parentMenu.isRootMenu ? parentMenu.getPopupContainer : function (triggerNode) {
